...
namespace Spell
{
    ...
    auto VolcanoSpray = Spell::Base(Spell::Class::Blasting, Spell::Type::VolcanoSpray, 1, "Volcano Spray", "Causes all enemies in the vicinity to lose one Die Endurance. This is a Blasting spell, so it cannot be resisted. The enemies' Armour Rating, if any, is deducted from the damage Die roll.", Assets::Type::VolcanoSpray, false);
    auto Nighthowl = Spell::Base(Spell::Class::Psychic, Spell::Type::Nighthowl, 1, "Nighthowl", "A Psychic spell that affects a single opponent. If the opponent fails to resist, he/she/it must make fight or shoot rolls using one Die more than usual (that is, on 3D rather than 2D) for the next four Rounds.", Assets::Type::Nighthowl, true);
    ...
    auto EyeOfTheTiger = Spell::Base(Spell::Class::Psychic, Spell::Type::EyeOfTheTiger, 2, "Eye of the Tiger", "When this spell is cast, you can either add two to your Fighting Prowess and damage rolls or add one to the Fighting Prowess and damage rolls of everyone in the party including yourself. This lasts for four Rounds of combat.", Assets::Type::EyeOfTheTiger, false);
